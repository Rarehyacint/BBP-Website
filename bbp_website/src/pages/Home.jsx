...
export default function Home() {
  return (
    <div className="bg-background-soft text-dark font-manrope min-h-screen">
      <SiteHeader variant="gradient" />
      ...
      {/* Browse by Visa Type */}
      <section className="px-6 py-8 max-w-7xl mx-auto">
        <h2 className="font-poppins font-bold text-2xl text-dark mb-4">Browse by Visa Type</h2>
      ...
      <section className="px-6 py-10 max-w-7xl mx-auto">
        <div className="bg-gradient-to-r from-[#59b9f6]/10 to-[#1f4e79]/15 rounded-3xl p-8 border border-[#59b9f6]/20">
          <div className="flex flex-wrap items-center justify-between gap-6">
            <div>
              <span className="font-poppins font-bold text-3xl text-primary-dark">Unang Lipad</span>
              <span className="ml-3 text-lg text-muted font-poppins">– First Time Travelers</span>
        ...
        <div className="bg-gradient-to-r from-[#59b9f6]/50 to-[#1f4e79]/100 rounded-3xl p-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {servicesList.map((service, idx) => (
              <div
                key={idx}
                className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition flex flex-col items-center text-center"
              >
